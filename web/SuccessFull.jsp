...
<div id="wrapper" style="margin-top:-10px;">
        ...
        <div id="page-content-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 id="main"><span>O</span><span class="main-text-other">Online Complain Center</span><small><abbr title="Metropolitan Complain Center">MCC<abbr></small></h1>
                                        <p class="para">Thanks For your Complain against improper think happened in Society.You Registered Complain Against this Nic <b><%out.print(request.getParameter("nic"));%></b>. Your Tracking Code is <b><%out.print(request.getParameter("code"));%></b> To keep track of the Complain we will Examine your Complain and Resolve as soon as possible,Regards <small><abbr title="Metropolitan Complain Center">MCC<abbr></small></p>
