      ...
      <div class="row row-offcanvas row-offcanvas-left">
        ...
        <div class="col-sm-9 col-md-10 main">
          ...
          <hr>
            ...
            String insert="select *from localuc where uc='"+request.getParameter("uc")+"'";
            rs=statement.executeQuery(insert);%>
          
            
          
          <div class="table-responsive">
              <center><h2 class="sub-header"><%uc=request.getParameter("uc");
              out.print(uc.substring(0, 4)+" Detailes");%></h2></center>
			...
			<th>
             ...
             <%while(rs.next()){%>
                      ...
                      <tr> 
			<td>
                            <%out.print(rs.getString("chairmon"));%>
			</td>
			
			<td>
                             <%out.print(rs.getString("voiceChairmon"));%>
			</td>
			
			<td>
                             <%out.print(rs.getString("concelour"));%>
			</td>
